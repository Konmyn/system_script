...
class aservice(win32serviceutil.ServiceFramework):
   ...
   _svc_name_ = "odoo"
   _svc_display_name_ = "odoo-bin service 10.0"
   _svc_description_ = "odoo 10 as windows service"
   ...
   def SvcDoRun(self):
      ...
      while 1:
         ...
         if rc == win32event.WAIT_OBJECT_0:
            ...
            servicemanager.LogInfoMsg("odoo STOPPED!")  #For Event Log
            break
         else:
